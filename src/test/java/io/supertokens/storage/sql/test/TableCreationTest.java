...
public class TableCreationTest {
    ...
    public void checkingCreationOfNewTable() throws InterruptedException {
        ...
        assertNotNull(process
                .checkOrWaitForEventInPlugin(io.supertokens.storage.sql.ProcessState.PROCESS_STATE.CREATING_NEW_TABLE));
        ...
        assertNull(process.checkOrWaitForEventInPlugin(
                io.supertokens.storage.sql.ProcessState.PROCESS_STATE.CREATING_NEW_TABLE, 2000));
